 ...
 * Compile :   Fri, 10 May 2024 15:19:51 GMT
 * Boucles :   _breves, _forums_liens, _syndic
 */ 

function BOUCLE_breveshtml_e4d141f80ff6f4dc8aec29346af587b9(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	return '';
}


function BOUCLE_forums_lienshtml_e4d141f80ff6f4dc8aec29346af587b9(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('forum.statut','publie,prop','publie',''));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/sommaire.html','html_e4d141f80ff6f4dc8aec29346af587b9','_forums_liens',49,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_syndichtml_e4d141f80ff6f4dc8aec29346af587b9(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('syndic_articles.statut','publie,prop','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/sommaire.html','html_e4d141f80ff6f4dc8aec29346af587b9','_syndic',61,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 364.625 ms
//

function html_e4d141f80ff6f4dc8aec29346af587b9($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/head') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/sommaire.html\',\'html_e4d141f80ff6f4dc8aec29346af587b9\',\'\',7,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
</head>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/header') . ', array(\'home\' => ' . argumenter_squelette('oui') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/sommaire.html\',\'html_e4d141f80ff6f4dc8aec29346af587b9\',\'\',13,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
	' .

'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/nav') . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes-dist/sommaire.html\',\'html_e4d141f80ff6f4dc8aec29346af587b9\',\'\',14,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/navsub') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/sommaire.html\',\'html_e4d141f80ff6f4dc8aec29346af587b9\',\'\',25,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
			' .
executer_balise_dynamique('FORMULAIRE_RECHERCHE',
	array(),
	array('squelettes-dist/sommaire.html','html_e4d141f80ff6f4dc8aec29346af587b9','',26,$GLOBALS['spip_lang'])) .
'
			
			
			' .
(($t1 = BOUCLE_breveshtml_e4d141f80ff6f4dc8aec29346af587b9($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'
			...
			' .
(($t1 = BOUCLE_forums_lienshtml_e4d141f80ff6f4dc8aec29346af587b9($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'
			...
			' .
(($t1 = BOUCLE_syndichtml_e4d141f80ff6f4dc8aec29346af587b9($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
			<div class="menu">
				<h2>' .
...
executer_balise_dynamique('FORMULAIRE_INSCRIPTION',
	array(),
	array('squelettes-dist/sommaire.html','html_e4d141f80ff6f4dc8aec29346af587b9','',37,$GLOBALS['spip_lang'])) .
'
		</aside><!--.aside-->
	</main><!--.main-->
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/footer') . ', array_merge('.var_export($Pile[0],1).',array(\'self\' => ' . argumenter_squelette(self()) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes-dist/sommaire.html\',\'html_e4d141f80ff6f4dc8aec29346af587b9\',\'\',41,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
');
	...
	return analyse_resultat_skel('html_e4d141f80ff6f4dc8aec29346af587b9', $Cache, $page, 'squelettes-dist/sommaire.html');
}
?>