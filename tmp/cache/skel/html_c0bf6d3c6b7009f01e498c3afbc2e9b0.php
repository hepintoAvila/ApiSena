...
function BOUCLE_anneehtml_c0bf6d3c6b7009f01e498c3afbc2e9b0(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_postdates('articles.date',''));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/inclure/footer.html','html_c0bf6d3c6b7009f01e498c3afbc2e9b0','_annee',3,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 52.342 ms
//

function html_c0bf6d3c6b7009f01e498c3afbc2e9b0($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'<footer class="footer clearfix" role="contentinfo">
	<p class="colophon">
		' .
(($t1 = BOUCLE_anneehtml_c0bf6d3c6b7009f01e498c3afbc2e9b0($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . ' - ') :
		'') .
...
(($t1 = strval(interdire_scripts(invalideur_session($Cache, ((table_valeur($GLOBALS["visiteur_session"], (string)'id_auteur', null)) ?' ' :'')))))!=='' ?
	...
	array(),
	array('squelettes-dist/inclure/footer.html','html_c0bf6d3c6b7009f01e498c3afbc2e9b0','',5,$GLOBALS['spip_lang'])) .
	'" rel="nofollow">' .
...
'" class="last">RSS&nbsp;2.0</a>
	...
	' .
(($t1 = strval(filtre_balise_svg_dist(find_in_path('spip.svg'),'','SPIP')))!=='' ?
...
'
	...
	return analyse_resultat_skel('html_c0bf6d3c6b7009f01e498c3afbc2e9b0', $Cache, $page, 'squelettes-dist/inclure/footer.html');
}
?>