...
switch($_POST['accion']) {
		...
		break;		
		case "matriculados":
            include_spip('exec/model/registro/matriculados');		    
		break;
		case "graduados":
			include_spip('exec/model/registro/graduados');		    
		break;
		case "programas":
			include_spip('exec/model/registro/programas');		    
		break;
		case "nivel_dos":
            include_spip('exec/model/nivel_uno/nivel_dos');		    
		break;			
}
