	...
	if (is_null($infos_tables) or $plugin_hash !== $_PLUGINS_HASH) {
		...
		$infos_tables = array(
			...
			'sena_aprendiz' => array(
				'page' => 'aprendices',
				'url_voir' => 'aprendices',
				'url_edit' => 'aprendiz_edit',
				'texte_retour' => 'icone_retour',
				'texte_objets' => 'public:aprendices',
				'texte_objet' => 'public:aprendices',
				'texte_modifier' => 'icone_modifier_aprendices',
				'texte_creer' => 'icone_creer_aprendices',
				'texte_ajouter' => 'titre_ajouter_une_aprendices',
				'texte_creer_associer' => 'creer_et_associer_une_aprendices',
				'info_aucun_objet' => 'info_aucun_aprendices',
				'info_1_objet' => 'info_1_aprendices',
				'info_nb_objets' => 'info_nb_aprendices',
				'texte_logo_objet' => 'logo_aprendices',
				'texte_langue_objet' => 'titre_langue_aprendices',
				'texte_definir_comme_traduction_objet' => 'texte_definir_comme_traduction_aprendices',
				'nombre' => 'nombre, lang',
				'maj' => 'maj',
				'principale' => 'oui',
				'introduction_longueur' => '600',
				'champs_editables' => array('nombres', 'apellidos', 'identificacion','telefono', 'correo', 'direccion'),
				'champs_versionnes' => array('nombres', 'apellidos', 'identificacion', 'correo'),
				'field' => array(
					'idAprendiz' => 'bigint(21) NOT NULL',
					'nombres' => "varchar(255) DEFAULT '0' NOT NULL",
					'apellidos' => "varchar(255) DEFAULT '0' NOT NULL",
					'tipoIdentificacion' => "varchar(4) DEFAULT '0' NOT NULL",
					'identificacion' => "varchar(255) DEFAULT '0' NOT NULL",
					'telefono' => "varchar(255) DEFAULT '0' NOT NULL",
					'correo' => "varchar(255) DEFAULT '0' NOT NULL",
					'direccion' => "text DEFAULT '' NOT NULL",
					'programaFormacion' => "text DEFAULT '' NOT NULL",
					'proyectoFormativo' => "text DEFAULT '' NOT NULL",
					'statut' => "varchar(10) DEFAULT '0' NOT NULL",
					'avatar' => "varchar(50) DEFAULT '0' NOT NULL",
					'entidad' => "varchar(10) DEFAULT '0' NOT NULL",
					'maj' => 'TIMESTAMP',
				),
				'key' => array(
				...
				'sena_solicitudcomite' => array(
				'page' => 'comites',
				'url_voir' => 'comites',
				'url_edit' => 'comite_edit',
				'texte_retour' => 'icone_retour',
				'texte_objets' => 'public:comites',
				'texte_objet' => 'public:comites',
				'texte_modifier' => 'icone_modifier_comites',
				'texte_creer' => 'icone_creer_comites',
				'texte_ajouter' => 'titre_ajouter_une_comites',
				'texte_creer_associer' => 'creer_et_associer_une_comites',
				'info_aucun_objet' => 'info_aucun_comites',
				'info_1_objet' => 'info_1_comites',
				'info_nb_objets' => 'info_nb_comites',
				'texte_logo_objet' => 'logo_comites',
				'texte_langue_objet' => 'titre_langue_comites',
				'texte_definir_comme_traduction_objet' => 'texte_definir_comme_traduction_comites',
				'codigoFicha' => 'codigoFicha, lang',
				'maj' => 'maj',
				'principale' => 'oui',
				'introduction_longueur' => '600',
				'champs_editables' => array('codigoFicha', 'idInstructor ', 'tipoSolicitud','tipoAtencion', 'codigoFicha', 'fechaHora', 'hechos', 'estado'),
				'champs_versionnes' => array('codigoFicha', 'idInstructor ', 'tipoSolicitud','tipoAtencion', 'codigoFicha', 'fechaHora', 'hechos', 'estado'),
				'field' => array(
					'idSolicitud' => 'bigint(21) NOT NULL',
					'idInstructor' =>  'bigint(21) NOT NULL',
					'idAprendiz' =>  'bigint(21) NOT NULL',
					'tipoSolicitud' => "varchar(255) DEFAULT '0' NOT NULL",
					'tipoAtencion' => "varchar(255) DEFAULT '0' NOT NULL",
					'codigoFicha' => "varchar(255) DEFAULT '0' NOT NULL",
					'fechaIncidente' => "datetime DEFAULT '0000-00-00 00:00:00' NOT NULL",
					'fechaHoraAgendada' => "datetime DEFAULT '0000-00-00 00:00:00' NOT NULL",
					'hechos' => "text DEFAULT '' NOT NULL",
					'nombrePrograma' => "text DEFAULT '' NOT NULL",
					'estado' =>  "varchar(10) DEFAULT '0' NOT NULL",
					'entidad' => "varchar(10) DEFAULT '0' NOT NULL",
					'statut' => "varchar(15) DEFAULT 'SIN AGENDAR' NOT NULL",
			...
			'sena_directivo' => array(
				'page' => 'directivos',
				'url_voir' => 'directivo',
				'url_edit' => 'directivo_edit',
				'texte_retour' => 'icone_retour',
				'texte_objets' => 'public:directivos',
				'texte_objet' => 'public:directivos',
				'texte_modifier' => 'icone_modifier_directivos',
				'texte_creer' => 'icone_creer_directivos',
				'texte_ajouter' => 'titre_ajouter_une_directivos',
				'texte_creer_associer' => 'creer_et_associer_une_directivos',
				'info_aucun_objet' => 'info_aucun_directivos',
				'info_1_objet' => 'info_1_directivos',
				'info_nb_objets' => 'info_nb_directivos',
				'texte_logo_objet' => 'logo_directivos',
				'texte_langue_objet' => 'titre_langue_directivos',
				'texte_definir_comme_traduction_objet' => 'texte_definir_comme_traduction_directivos',
				'identificacion' => 'identificacion, lang',
				'maj' => 'maj',
				'principale' => 'oui',
				'introduction_longueur' => '600',
				...
				'field' => array(
					...
					'correo' => "varchar(255) DEFAULT '0' NOT NULL",
					'celular' => "varchar(255) DEFAULT '0' NOT NULL",
					'entidad' => "datetime DEFAULT '0000-00-00 00:00:00' NOT NULL",
					'statut' => "varchar(15) DEFAULT 'SIN AGENDAR' NOT NULL",
					'maj' => 'TIMESTAMP',
				),
				'key' => array(
				...
				'page' => 'agendas',
				'url_voir' => 'agenda',
				'url_edit' => 'agenda_edit',
				'texte_retour' => 'icone_retour',
				'texte_objets' => 'public:agendas',
				'texte_objet' => 'public:agendas',
				'texte_modifier' => 'icone_modifier_agendas',
				'texte_creer' => 'icone_creer_agendas',
				'texte_ajouter' => 'titre_ajouter_une_agendas',
				'texte_creer_associer' => 'creer_et_associer_une_agendas',
				'info_aucun_objet' => 'info_aucun_agendas',
				'info_1_objet' => 'info_1_agendas',
				'info_nb_objets' => 'info_nb_agendas',
				'texte_logo_objet' => 'logo_agendas',
				'texte_langue_objet' => 'titre_langue_agendas',
				'texte_definir_comme_traduction_objet' => 'texte_definir_comme_traduction_agendas',
				'hechos' => 'hechos, lang',
				'maj' => 'maj',
				'principale' => 'oui',
				'introduction_longueur' => '600',
				...
				'field' => array(
					...
					'entidad' =>"varchar(15) DEFAULT '0' NOT NULL",
					'statut' => "varchar(15) DEFAULT '' NOT NULL",
					'maj' => 'TIMESTAMP',
				),
				'key' => array(
			...
			'spip_auteurs' => array(
				...
				'date' => 'date',
				'principale' => 'oui',
				'champs_editables' => array('nom', 'email', 'bio', 'nom_site', 'url_site', 'imessage', 'pgp','tipo','entidad'),
				'champs_versionnes' => array('nom', 'bio', 'email', 'nom_site', 'url_site', 'login','tipo','entidad'),
				'field' => array(
					'id_auteur' => 'bigint(21) NOT NULL',
					...
					'entidad' => "VARCHAR(25) DEFAULT '' NOT NULL"
				),
				'key' => array(
					'PRIMARY KEY' => 'id_auteur',
					'KEY login' => 'login',
